<h2><a href="https://www.geeksforgeeks.org/problems/next-permutation5226/1?page=1&difficulty=Medium&status=unsolved,attempted&sortBy=submissions">Next Permutation</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of integers <strong>arr[]</strong> representing a permutation, implement the&nbsp;<strong>next permutation</strong> that rearranges the numbers into the lexicographically next greater permutation. If no such permutation exists, rearrange the numbers into the lowest possible order (i.e. sorted in ascending order).</span></p>
<p><span style="font-size: 18px;">Note: A permutation of <strong>n&nbsp;</strong>numbers is any possible arrangement of all the integers in range [1,n] where each integer occurs exactly once.&nbsp;</span></p>
