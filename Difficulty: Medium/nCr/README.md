<h2><a href="https://www.geeksforgeeks.org/problems/ncr1019/1?page=1&difficulty=Medium&status=unsolved,attempted&sortBy=submissions">nCr</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two integers&nbsp;n and r, find <sup>n</sup>C<sub>r. </sub>Since the answer may be very large, calculate the answer modulo&nbsp;10<sup>9</sup>+7.<br>Note : If r is greater than n, return 0.</span></p>
